...
curl -u "ci:$NEXUS_PASSWORD"  -H "Content-Type: multipart/form-data" --data-binary "@./releases/$GIT_TAG/clever-tools-$GIT_TAG.deb" "http://nexus.clever-cloud.com/repository/deb/"
